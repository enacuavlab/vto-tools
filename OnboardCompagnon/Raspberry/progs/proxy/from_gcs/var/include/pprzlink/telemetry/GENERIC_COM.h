 ...
 * @param _flight_time 
 */
static inline void pprzlink_msg_v2_send_GENERIC_COM(struct pprzlink_msg * msg, int32_t *_lat, int32_t *_lon, int16_t *_alt, uint16_t *_gspeed, int16_t *_course, uint16_t *_airspeed, uint8_t *_vsupply, uint8_t *_energy, uint8_t *_throttle, uint8_t *_ap_mode, uint8_t *_nav_block, uint16_t *_flight_time) {
  ...
  if (msg->trans->check_available_space(msg, _FD_ADDR, size)) {
    ...
    msg->trans->put_bytes(msg, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, (void *) _energy, 1);
...
static inline void pprz_msg_send_GENERIC_COM(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, int32_t *_lat, int32_t *_lon, int16_t *_alt, uint16_t *_gspeed, int16_t *_course, uint16_t *_airspeed, uint8_t *_vsupply, uint8_t *_energy, uint8_t *_throttle, uint8_t *_ap_mode, uint8_t *_nav_block, uint16_t *_flight_time) {
    ...
    msg.receiver_id = 0;
    msg.component_id = 0;
    pprzlink_msg_v2_send_GENERIC_COM(&msg,_lat,_lon,_alt,_gspeed,_course,_airspeed,_vsupply,_energy,_throttle,_ap_mode,_nav_block,_flight_time);
}
...
/** Getter for field energy in message GENERIC_COM
  *
  * @param _payload : a pointer to the GENERIC_COM message
  * @return 
  */
static inline uint8_t pprzlink_get_DL_GENERIC_COM_energy(uint8_t * _payload __attribute__((unused)))
{
...
#define DL_GENERIC_COM_energy(_payload) pprzlink_get_DL_GENERIC_COM_energy(_payload)
