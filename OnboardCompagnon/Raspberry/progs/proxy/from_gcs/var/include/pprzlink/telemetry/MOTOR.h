 ...
 * @param _current 
 */
static inline void pprzlink_msg_v2_send_MOTOR(struct pprzlink_msg * msg, uint16_t *_rpm, int32_t *_current) {
...
/** Getter for field current in message MOTOR
  ...
  * @return 
  */
static inline int32_t pprzlink_get_DL_MOTOR_current(uint8_t * _payload __attribute__((unused)))
{
