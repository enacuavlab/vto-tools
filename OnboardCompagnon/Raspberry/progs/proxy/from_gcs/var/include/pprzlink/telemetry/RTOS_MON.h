 ...
 * @param _heap_free Heap free memory
 * @param _cpu_time 
 */
static inline void pprzlink_msg_v2_send_RTOS_MON(struct pprzlink_msg * msg, uint8_t *_nb_threads, uint8_t *_cpu_load, uint32_t *_core_free, uint32_t *_heap_free, float *_cpu_time) {
...
static inline void pprz_msg_send_RTOS_MON(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, uint8_t *_nb_threads, uint8_t *_cpu_load, uint32_t *_core_free, uint32_t *_heap_free, float *_cpu_time) {
    ...
    msg.receiver_id = 0;
    msg.component_id = 0;
    pprzlink_msg_v2_send_RTOS_MON(&msg,_nb_threads,_cpu_load,_core_free,_heap_free,_cpu_time);
}
