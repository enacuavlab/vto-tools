...
char * MyUnpack(char * pPacketIn,int major,int minor,char *data);
char* UnpackPacketHeader(char* ptr, int& messageID, int& nBytes, int& nBytesTotal);
// Frame data
char * UnpackFrameData(char* inptr, int nBytes, int major, int minor,char *data);
char * UnpackFramePrefixData(char * ptr, int major, int minor);
char * UnpackMarkersetData(char * ptr, int major, int minor);
char * UnpackRigidBodyData(char * ptr, int major, int minor, char *data);
...
char * MyUnpack(char * pData,int major, int minor, char *data)
{
